...
class Communication implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'Communication';
    ...
    */
     ...
     * Sets msisdn
     *
     * @param null|string $msisdn msisdn
     */
    public function setMsisdn(mixed $msisdn): static
    {
        if (is_null($msisdn)) {
     ...
     * Sets email_address
     *
     * @param null|string $email_address email_address
     */
    public function setEmailAddress(mixed $email_address): static
    {
