...
class Styling implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'Styling';
    ...
    */
     ...
     * @return null|string
     */
    public function getLogoUrl(): mixed
    {
     ...
     * Sets logo_url
     *
     * @param null|string $logo_url logo_url
     */
    public function setLogoUrl(mixed $logo_url): static
    {
        if (is_null($logo_url)) {
     ...
     * @return null|string
     */
    public function getBannerUrl(): mixed
    {
     ...
     * Sets banner_url
     *
     * @param null|string $banner_url banner_url
     */
    public function setBannerUrl(mixed $banner_url): static
    {
     ...
     */
    public function setTheme(mixed $theme): static
    {
        if (is_null($theme)) {
