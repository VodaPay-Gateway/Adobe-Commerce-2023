 ...
 */
class VodaPayGatewayTokenResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'VodaPayGatewayTokenResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('initiation_url', $data ?? [], null);
    }
    ...
    */
     ...
     * @return null|string
     */
    public function getInitiationUrl(): mixed
    {
     ...
     * Sets initiation_url
     *
     * @param null|string $initiation_url initiation_url
     */
    public function setInitiationUrl(mixed $initiation_url): static
    {
        if (is_null($initiation_url)) {
            throw new \InvalidArgumentException('non-nullable initiation_url cannot be null');
        }
