 ...
 */
class PaymentDigitalWalletResponseModelAllOf implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'PaymentDigitalWalletResponseModel_allOf';
