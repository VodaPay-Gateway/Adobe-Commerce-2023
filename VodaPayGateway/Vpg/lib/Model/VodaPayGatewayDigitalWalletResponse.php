 ...
 */
class VodaPayGatewayDigitalWalletResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'VodaPayGatewayDigitalWalletResponse';
