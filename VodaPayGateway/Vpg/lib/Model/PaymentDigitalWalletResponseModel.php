 ...
 */
class PaymentDigitalWalletResponseModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'PaymentDigitalWalletResponseModel';
