 ...
 */
class VodaPayGatewaySubmitRecurringResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'VodaPayGatewaySubmitRecurringResponse';
