 ...
 */
class VodaPayGatewayRecurringAllOf implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'VodaPayGatewayRecurring_allOf';
