...
class Notifications implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'Notifications';
    ...
    */
     ...
     * Sets callback_url
     *
     * @param null|string $callback_url callback_url
     */
    public function setCallbackUrl(mixed $callback_url): static
    {
     ...
     * @return null|string
     */
    public function getNotificationUrl(): mixed
    {
     ...
     *
     * @param null|string $notification_url notification_url
     */
    public function setNotificationUrl(mixed $notification_url): static
    {
